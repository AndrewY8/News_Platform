...
Operating expenses were $345 million, slightly above guidance due to higher variable compensation on stronger-than-expected results. Operating income was $732 million, translating into an operating margin of 28.1%. Interest and other expenses were $52

million, a substantial reduction from the prior quarter due to the repayment of $2.6 billion of debt during the quarter. Taking into account an effective tax rate of 9.3% and a diluted share count of 362 million shares, EPS was $1.66, up 22% sequentially.
...
As you know, in gross margins, there's multiple elements that go into it. There is pricing, the risk mix, the risk cost. And in each of those fronts, I think the company is executing really well. Pricing is very stable environment. The mix is shifting in the right direction to higher capacity drives that is accretive to gross margins and the operational team is executing really well, driving down cost reductions in the factories as well throughout the supply chain. And so I do believe there is further gross margin progression. We guided now Q1 of fiscal '26 to 41% to 42%. I'm confident that the team will execute well and continue to focus on further gross margin improvements over time.

Operator

[Operator Instructions] The next question comes from Aaron Rakers with Wells Fargo.

Aaron Christopher Rakers

I do have 2 and I'll wait to ask a follow-up. I guess the first question, Kris, congrats on the results as well. But you've taken the debt down, you're well within your targeted range of 1 to 1.5 on a leverage ratio basis, strong free cash flow generation, you've got $2.1 billion of cash on the balance sheet. I'm curious as you start to think about share repurchase activity going forward, how should we as investors think about that? Or how do you think about excess cash generation or the right level of cash on the balance sheet that you'll operate the business at or rather the capacity for even stepping further on share repurchase going forward?

Kris Sennesael

Yes, Aaron, that's a great question. And here again, I'm really pleased with what I've seen in the company as well in terms of capital, capital structure and capital allocation. And just to summarize it as well, there is very strong free cash flow. Just last quarter, the first quarter as the stand-alone hardest drive company, we generated $675 million of free cash flow which was a 26% free cash flow margin. Now not each and every quarter will be as strong as last quarter, but the business model is really a strong free cash flow business model.

In addition to that, the company has done a great job at strengthening the balance sheet at the time of the separation as well as last quarter where we retired $2.6 billion of debt now getting to a net debt of $2.6 billion, which is on or about onetime LTM EBITDA. So really good job there. And so there's no hesitation from the Board, to the management team to continue to return cash back to the shareholders through a combination of our dividend program and the share repurchase program.
...
Yes, I do, Ambrish. One of the metrics that you guys have historically given and helps kind of bridge the hard disk drive versus the non-hard disk drive business was the ASP. I didn't see that in tonight's release. So I'm curious if that's something that you could talk to? Or I guess, maybe put another way, how do we think about the non-HDD revenue in this most recent quarter?

Tiang Yew Tan

Yes. Aaron, thanks for the question. This is Irving. Obviously, ASP per terabyte is obviously a function of mix by and large. But I would say for last quarter, ASP per terabyte was down low single digits.
...
Okay. That's super helpful, Irving. And as my follow-up, Kris, I just wanted to go back to the incremental margin question that Erik asked around, and you answered with the moving pieces being price, mix and cost. So if we think about the sequential improvement in this June quarter of 120 bps, what would you say was the biggest driver between those 3 elements. And as we look forward, where
...
Thank you for your 2 questions, Asiya. We go to the next caller please.
...
I'm just wondering, could you actually quantify the hard drive ASPs in the quarter?
...
The average selling price -- yes, for hard drives.

Ambrish Srivastava

Yes. So we -- as you see the disclosures. This is Ambrish. We have stopped providing ASP per unit because as Irving highlighted earlier, that what's more important for our business is EP. And so just to give you a context of why we changed and what we are providing now. Kris, do you want to add to that?
...
systemPrompt = """
You are an experienced financial analyst who has listened to many earnings transcript calls.
